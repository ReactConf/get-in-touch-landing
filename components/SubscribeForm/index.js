        ...
        return (
            <FormBox>
                <ModalButton>
                    ...
                    >
                        <IntlMessages id="form.modal.btn" />
                    </Button>
                </ModalButton>
                <Modal
                                ...
                                rules: [
                                    {
                                        ...
                                        message: this.context.intl.formatMessage(
                                            {
                                                id:
                                                    "form.modal.experience.validation",
                                            }
                                        ),
                                    },
                                ],
                                ...
                                rules: [
                                    {
                                        ...
                                        message: this.context.intl.formatMessage(
                                            {
                                                id:
                                                    "form.modal.email.validation.format",
                                            }
                                        ),
                                    },
                                    {
